...
double exact_solution( double dim ){
...
int main() {
    ...
    gDiff_MC->SetMarkerStyle(22);
    gDiff_MC->SetMarkerSize(1.8);
    gDiff_MC->SetMarkerColor(kGray+2);
    gDiff_MPS->SetMarkerStyle(33);
    gDiff_MPS->SetMarkerSize(2);
    ...
    c2->SaveAs("Difference_true_sim_value_5-3.pdf");  
